...
import com.ubergeek42.WeechatAndroid.utils.Utils.isValidTimestampFormat
...
object LookAndFeelPreferences {
    ...
    val timestampFormat = T("timestamp_format", "HH:mm:ss")
            .addValidator(Utils::isValidTimestampFormat)
