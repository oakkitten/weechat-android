...
import com.ubergeek42.WeechatAndroid.service.requestExactAlarmPermission
...
class WeechatActivity : AppCompatActivity(), CutePageChangeListener,
    ...
    private val notificationPermissionChecker = when {
    ...
    @MainThread @CatD(linger = true) fun connect() {
        ...
        if (notificationPermissionChecker?.shouldRequestNotificationPermission() == true) {
            notificationPermissionChecker.requestNotificationPermission()
            return
        }
